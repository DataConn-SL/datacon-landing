    ...
    <section className="pt-32 pb-20 relative overflow-hidden h-74">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <br />
          <h1 className="text-3xl md:text-7xl font-bold my-8 ">
            DataConn
          </h1>

          <p className="text-gray-400 text-xl mb-8 max-w-2xl mx-auto">
          DataCon is a consortium of organization geared towards creating a data and AI ecosystem that powers innovation
      ...
      <div className="text-center mt-32">
        ...
        <h1 className="text-4xl font-bold text-gray-400">Partners</h1>
        <div className="mt-8 flex justify-center gap-12 flex-wrap">
          <img src="/images/datasynk.png" alt="Datasynk logo" className="h-16 opacity-70" />
          <img src="/images/fortizo.png" alt="Fortizo logo" className="h-16 opacity-70" />
          <img src="/images/dorbai.png" alt="Dorb Ai logo" className="h-16 opacity-70 filter grayscale invert" />
          <img src="/images/geneline.png" alt="Geneline logo" className="h-16 opacity-70 grayscale " />
          <img src="/images/peeap-pay.png" alt="Peeap Pay logo" className="h-16 opacity-70 filter grayscale invert" />
        </div>

        <p className="text-lg text-gray-400 mt-8 font-weight-100">
          Data is the foundation of modern technological advancements, yet Sierra Leone faces a
          significant lack of structured, reliable, and scalable data infrastructure. This has resulted
          in challenges across multiple industries, including education, healthcare, finance, and AI
          development, where localized datasets are essential for effective decision-making and
          innovation.<br />
          Recognizing this gap, DataCon was formed as a collaborative consortium comprising
          DataSynk, Geneline-X, DorbAI, Fortizo Technologies, Peapp Pay, Saful Pay, and other
          strategic partners. The consortium’s objective is to create a reliable, scalable, and
          interoperable data ecosystem that enables efficient data collection, secure storage,
          intelligent processing, and AI-driven analytics to power innovation and economic growth
          in Sierra Leone
</p>
      </div>
    </section>
