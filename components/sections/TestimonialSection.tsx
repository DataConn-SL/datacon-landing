      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Don't just take our word for it. See what our customers have to say about DataConn.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-black-200 rounded-xl border border-gray-800 p-6">
            ...
            <p className="text-gray-300">
              "DataConn has transformed how we manage our business operations. The platform is intuitive, powerful, and
              has saved us countless hours of administrative work."
            </p>
          </div>
          ...
          <div className="bg-black-200 rounded-xl border border-gray-800 p-6">
            ...
            <p className="text-gray-300">
              "The analytics features in DataConn have given us insights we never had before. We've been able to make
              data-driven decisions that have significantly improved our bottom line."
            </p>
          </div>
        </div>
